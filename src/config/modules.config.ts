...
export const MODULOS_PLATAFORMA: ModuloPlataforma[] = [
  ...
  {id:'conteos',nombre:'Conteos de inventario',grupo:'Inventario y WMS',icono:ClipboardList,ruta:'/app/escanear/qr',planes:['pro','enterprise'],disponible:true,descripcion:'Inventario general y ciclico'},
