    ...
    <div className="space-y-5">
      ...
      <Modal open={modal} onClose={() => setModal(false)} title={esRestaurante ? 'Nuevo producto de restaurante' : 'Nuevo producto'} size="lg"
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          {esRestaurante && <><div><label className="label">Codigo</label><input className="input" placeholder="Ej: PLA-001" value={form.codigo} onChange={e=>setForm(p=>({...p,codigo:e.target.value}))}/></div>
