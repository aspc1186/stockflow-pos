...
interface Empresa { id: string; nombre: string; slug: string; tipo: string; plan?: string; modulos_extra?: string[]; logo_url?: string; color_primario?: string; telefono?: string; email?: string; ciudad?: string; licencia_fin?: string; tema?: string; fondo_url?: string; notificacion_pago?: string; notificacion_pago_at?: string }
